...
- a new vintage
- a new dollar
- a new name / address / officer
- a contradiction of a locked row
...
search_n − search_{n-1} = the only write
...
Same rule for every later city and every later entity.
