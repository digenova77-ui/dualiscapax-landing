...
(function (global) {
  ...
  DualisVideoEngine.prototype._build = function () {
    ...
    var self = this;
    var prev = this.root.querySelector('[data-tour-prev]');
    var next = this.root.querySelector('[data-tour-next]');
  ...
  DualisVideoEngine.prototype.go = function (idx) {
    ...
    if (global.DualisFeedback && typeof global.DualisFeedback.emit === 'function') {
      global.DualisFeedback.emit({ kind: 'tick', channels: ['visual'], intensity: 0.35 });
    }
  };
