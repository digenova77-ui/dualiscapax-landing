...
2. City fact-check = this § municipalities + that CSD SEAL.md. Never CSD+CMA smash.
...
## Four Ontario CSDs
Belleville = plate (55,071; dens 223; own 62.5%). Quinte West = neighbour different species (OPP, CFB — not Pearson). Kingston = own book. Toronto CSD = ceiling (2,794,356; dens 4,428; own 52%; not CMA 6.2M; Pearson is Mississauga).
Leaves: research/geo/belleville/SEAL.md · quinte-west/SEAL.md · kingston/KINGSTON.md · toronto/SEAL.md

## Medical
~131 catalog IDs. Live/depth: ALS, PD, AD, osteosarcoma, GBM. Not advice. Catalog file is the table; do not dump 131 journals into this bind.

## Cross-check
INTAKE must name ID + GEO_or_CATALOG + YEAR + SRC + STAMP.
Reprint of a sealed cell is noise.
HD arriving daily goes into that CSD or catalog leaf — not a new Drive root.
